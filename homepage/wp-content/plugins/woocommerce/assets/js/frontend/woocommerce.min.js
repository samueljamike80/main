...
jQuery(function(e) {
    ...
    "hidden" === Cookies.get(o) ? e(".woocommerce-store-notice").hide() : e(".woocommerce-store-notice").show(), e(".woocommerce-store-notice__dismiss-link").on("click", function(t) {
        ...
        e(this).append('<button class="show-password-input" aria-label="' + woocommerce_params.i18n_password_show + '" aria-describedBy="' + o + '"></button>'), e(this).on("keydown", function(e) {
        ...
        "Enter" === o.key && e(this).closest("form").find("[type=submit]").click()
