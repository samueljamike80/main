! function(f) {
    ...
    function e(t, e, n) {
        ...
        if ("GET" !== r.type && void 0 !== window.FormData) r.data = new FormData(e), r.processData = !1, r.contentType = !1;
        else {
    ...
    function h(u) {
        ...
        u.data || (u.data = {}), Array.isArray(u.data) ? u.data.push({
            ...
            var t = h.state,
                ...
                a = o.getResponseHeader("X-PJAX-Version"),
                i = w(n, o, u),
                c = j(i.url);
            if (l && (c.hash = l, i.url = c.href), e && a && e !== a) m(i.url);
            else if (i.contents) {
                if (h.state = {
                        id: u.id || g(),
                        url: i.url,
    ...
    function i(t) {
        var e, n = "function" == typeof t.url ? t.url() : t.url,
    ...
    function u(t, e) {
        return t && e ? ((e = f.extend({}, e)).container = t, e) : f.isPlainObject(t) ? t : {
            container: t
        }
    }
