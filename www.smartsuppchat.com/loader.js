...
(() => {
    var t = {
            ...
            761: (t, e, n) => {
                ...
                const s = function(t) {
                    ...
                    return new e((function(n, r) {
                        ...
                        for (var s = [], a = 0; a < o.length; a++) try {
                            e.resolve(o[a]).then(n).catch((function(t) {
                                s.push(t), s.length === o.length && r(new i(s, "All promises were rejected"))
                            }))
                        } catch (t) {
                            r(t)
                        }
                ...
                function l(t) {
                    ...
                    this._state = 0, this._handled = !1, this._value = void 0, this._deferreds = [], w(t, this)
                }
                ...
                function f(t, e) {
                    try {
                        ...
                        if (e && ("object" == typeof e || "function" == typeof e)) {
                            var n = e.then;
                            if (e instanceof l) return t._state = 3, t._value = e, void h(t);
                            if ("function" == typeof n) return void w((r = n, o = e, function() {
                                r.apply(o, arguments)
                            }), t)
                        }
                ...
                l.prototype.catch = function(t) {
                    ...
                    return p(this, new y(t, e, n)), n
                }, l.prototype.finally = r, l.all = function(t) {
                ...
                }, l.any = s, l.allSettled = o, l.resolve = function(t) {
                    ...
                    return new l((function(e, n) {
                        ...
                        for (var r = 0, o = t.length; r < o; r++) l.resolve(t[r]).then(e, n)
                    }))
                ...
                "function" != typeof g.Promise ? g.Promise = v : (g.Promise.prototype.finally || (g.Promise.prototype.finally = r), g.Promise.allSettled || (g.Promise.allSettled = o), g.Promise.any || (g.Promise.any = s))
            },
            345: (t, e, n) => {
                "use strict";
                    ...
                    s = function() {
                        ...
                        return t.prototype.setDefaults = function(t) {
                            ...
                            return u._initPromise = (0, o.request)("".concat(c.bootstrapUrl, "/widget/").concat(c.key, ".json")).then((function(t) {
                                ...
                                return delete e.features, u.init((0, o.mergeDeep)(n, e), n.features), e && e.widgetTrackerEnabled && (0, r.trackOptions)(u.options, Object.keys(e)), window.smartsupp.getAssetUrl = u.getAssetUrl.bind(u), s && s(void 0, u), u.options.renderTo && u.render(u.options.renderTo), null
                            })).catch((function(t) {
                                s && s(t)
                            })), u
                            ...
                            return a(c), (0, o.request)("".concat(c.bootstrapUrl, "/widget/").concat(c.key, ".json")).then((function(a) {
                                ...
                                return delete e.features, l.init((0, o.mergeDeep)(u, e), u.features), e && e.widgetTrackerEnabled && (0, r.trackOptions)(l.options, Object.keys(e)), window.smartsupp.getAssetUrl = l.getAssetUrl.bind(l), l
                            }))
                        }, t
                    }();
                e.SmartsuppLoader = s;
            ...
            893: (t, e) => {
                ...
                e.mergeDeep = function() {
                    ...
                    return n.type = "text/javascript", n.charset = "utf8", e && (n.src = e), n
                ...
                var i = n(740),
                    ...
                    u = function() {
                        ...
                        return t.prototype.setOptions = function(t) {
                            ...
                            this.features = e, this.setOptions(t), this.initialized = !0, "auto" === this.options.position && (this.options.position = this.options.renderTo ? "relative" : "fixed")
                        }, t.prototype.createFrame = function() {
                            var t = document.createElement("iframe");
                            return t.id = "".concat(this.id).concat(c), t.setAttribute("title", "Smartsupp"), t.setAttribute("aria-hidden", "true"), t.style.display = "block", t.style.position = "fixed", t.style.top = "0", t.style.left = "0", t.style.width = "1px", t.style.height = "1px", t.style.opacity = "0", t.style.border = "none", t.style.zIndex = "-1", t.style.pointerEvents = "none", t
                                ...
                                return o(this, (function(n) {
                                    switch (n.label) {
                                        ...
                                        case 1:
                                            n.sent(), n.label = 2;
                                        case 2:
                                            if (document.getElementById(this.id + c)) return [2];
                                            if (!this.initialized) throw new Error("failed to initialize widget");
                                            if (!(e = (0, s.resolveTargetElement)(t))) throw new Error("target element not found");
                                            return this.renderFrame(e), this.rendered = !0, [2]
                                    }
                                }))
                            }))
                            ...
                            n.addEventListener("load", (function() {
                                ...
                                e.options.widgetV3DevMode ? ["@vite/client", l].forEach(p) : r(e, void 0, void 0, (function() {
                                    var t, n, r, i;
                                    return o(this, (function(o) {
                                        switch (o.label) {
                                            ...
                                            case 1:
                                                ...
                                                })), null === (i = n.css) || void 0 === i || i.forEach(f), f(t["style.css"].file), [2]
                                        }
                                    }))
                                }))
                            })), t.appendChild(n)
                            ...
                            return void 0 === this.options[t] ? e : this.options[t]
                        }, t.prototype.getBaseUrl = function() {
                            return this.options.widgetV3Url
                            ...
                            if (this.api = t, a.smartsupp.api = t, this._pushApi && (this._pushApi.forEach((function(n) {
                                    ...
                                    try {
                                        e.options.widgetTrackerEnabled && (0, i.trackOperation)(e.options, r[0]), t.execute(r)
                                    } catch (t) {
                                        console.log(t)
                                    }
    ...
    n.g = function() {
        ...
        if (window.smartsupp || (window.smartsupp = function() {
            ...
            window.$smartsupp = o, window.smartsupp = Object.assign(window.smartsupp, {
                chats: o.widgets,
                create: o.create.bind(o),
                createWidget: o.createWidget.bind(o),
                getChat: o.getChat.bind(o),
                getWidget: o.getWidget.bind(o),
                setDefaults: o.setDefaults.bind(o)
            }), !1 !== window.SMARTSUPP_AUTOCREATE && (!0 === window.SMARTSUPP_BFCACHE && (window.addEventListener("pageshow", (function() {
                var t;
                null === (t = window.smartsupp.getWidget(r)) || void 0 === t || t.render()
            })), window.addEventListener("beforeunload", (function() {
                var t, e;
                null === (t = document.querySelector("#".concat(r, "-application-iframe"))) || void 0 === t || t.remove(), null === (e = document.querySelector("#smartsupp-widget-container")) || void 0 === e || e.remove()
            }))), t((function() {
                window.smartsupp("html:apply", document), o.createWidget(r, window._smartsupp, window.smartsupp._).then((function(t) {
                    return t.render()
                })).catch((function(t) {
                    console.warn(t)
                }))
